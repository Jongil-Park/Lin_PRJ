...
#define SDDC_I_DONG               		8       // I_Dong ID (Sport Complex)
...
#define CNT_I_MAX_POINT                 47      // I Dong Indoor GHP Count (Sport Complex)
...
#define USER_CONTROL_REMOTE_1			6
#define USER_CONTROL_REMOTE_2			7
#define USER_CONTROL_REMOTE_3			8
...
typedef struct __attribute__ ( (__packed__)) {
	...
	int	    remote_1;         // Remote Mode 1
	int	    remote_2;         // Remote Mode 2
	int	    remote_3;         // Remote Mode 3
	int	    filter;    
	// GHP schedule time
