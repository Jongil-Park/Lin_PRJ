...
/* PCM Control jong2ry 2010.01.11 */
#define PCM_VA_CTL	   S3C2410_ADDR(0x09000000)
...
#define AESOP_VA_CS8900A    S3C2410_ADDR(0x08000000)	 	/* 0xF8000000 */
#define AESOP_PA_CS8900A    (0x19000000 )			
